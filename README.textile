...
pre. :lein-release {:tag-format ["v" :version]}

This specifies the format of the SCM tag.  The above specifies that "v1.2.3" will be the tag for version 1.2.3.  The following keywords can be used:

* @:version@
* @:project-name@

@:version@ is the version being released, while @:project-name@ is the name of the project.  The default format is @[:project-name "-" :version]@.
